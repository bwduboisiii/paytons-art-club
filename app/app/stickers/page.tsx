...
// Map sticker keys to the display emoji. We look this up via the lesson that
// awards the sticker (completion_sticker). That way the sticker "icon" is
// just the lesson's subject emoji for now — good enough for launch.
...
export default function StickersPage() {
  ...
  // Total possible stickers (one per lesson)
              ...
              return (
                ...
                >
                  <div
                    className={clsx(
                      'text-6xl',
                      isEarned ? 'animate-bounce-soft' : 'grayscale'
                    )}
                  >
                    {isEarned ? emoji : '❓'}
                  </div>
